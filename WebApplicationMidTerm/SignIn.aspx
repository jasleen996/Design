...
KijijiAUTOS
    ...
    <div class="container4">
        ...
        <asp:TextBox class="text" ID="TextBox5" runat="server"></asp:TextBox><br />
           
        <asp:Label ID="Label2" runat="server" Text="Password"></asp:Label><br />
        <asp:TextBox class="text" ID="TextBox6" runat="server"></asp:TextBox><br />
       
        <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#0066FF" NavigateUrl="~/PasswordReset.aspx">Forgot Password?</asp:HyperLink>
        <asp:Button CssClass="point" ID="ButtonRegister" runat="server" Text="Sign In" />
